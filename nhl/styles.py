...
_CSS = """
    <style>
        ...
        /* Accessibility: respect prefers-reduced-motion.  The cache-spinner
           progress bar is the only infinite animation left after the skeleton
           removal, and it previously sat outside this guard. */
